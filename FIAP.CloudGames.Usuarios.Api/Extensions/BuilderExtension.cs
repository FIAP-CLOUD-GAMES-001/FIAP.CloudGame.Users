...
using FIAP.CloudGames.Usuarios.Infrastructure.Repositories;
using FIAP.CloudGames.Usuarios.Service.Auth;
using FIAP.CloudGames.Usuarios.Service.Game;
using FIAP.CloudGames.Usuarios.Service.User;
using FIAP.CloudGames.Usuarios.Service.Validators;
...
public static class BuilderExtension
{
    ...
    private static void UseJsonFileConfiguration(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddDataProtection()
            ...
            .SetApplicationName("FIAP.CloudGames.Usuarios");
